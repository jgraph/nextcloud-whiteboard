...
"drawiowhiteboard",
{
  "Open in Whiteboard" : "Open in Whiteboard",
  "Saving..." : "Saving...",
  ...
  "Yes" : "Yes",
  "No" : "No",
  "Associate XML files with Draw.io?" : "Associate XML files with draw.io Whiteboard?",
  "Please note: when you disable the XML association, you need to manually register the MIME type application/vnd.jgraph.mxfile for the extension \".drawio\"." : "Please note: when you disable the XML association, you need to manually register the MIME type application/vnd.jgraph.mxfile for the extension \".drawio\".",
  "Kennedy" : "Kennedy",
  "Minimal" : "Minimal",
  "Atlas" : "Atlas",
  "Dark" : "Dark",
  ...
  "draw.io Whiteboard app not configured! Please contact admin." : "draw.io Whiteboard app not configured! Please contact admin.",
  ...
  "Activate offline mode in draw.io Whiteboard?" : "Activate offline mode in draw.io Whiteboard?",
  "When the \"offline mode\" is active, this disables all remote operations and features to protect the users privacy. draw.io Whiteboard will then also only be in English, even if you set a different language manually." : "When the \"offline mode\" is active, this disables all remote operations and features to protect the users privacy. draw.io Whiteboard will then also only be in English, even if you set a different language manually.",
