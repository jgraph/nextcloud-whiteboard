...
"drawiowhiteboard",
{
  ...
  "Associate XML files with Draw.io?" : "Przejąć obsługę formatu XML?",
    "Please note: when you disable the XML association, you need to manually register the MIME type application/vnd.jgraph.mxfile for the extension \".drawio\"." : "Jeśli wyłączysz obsługę formatu XML, musisz ręcznie zarejestrować typ MIME application/vnd.jgraph.mxfile dla rozszerzenia \".drawio\".",
  "Kennedy" : "Kennedy",
  "Minimal" : "Minimal",
  "Atlas" : "Atlas",
  "Dark" : "Dark",
