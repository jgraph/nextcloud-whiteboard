...
"drawiowhiteboard",
{
  ...
  "Please note: when you disable the XML association, you need to manually register the MIME type application/vnd.jgraph.mxfile for the extension \".drawio\"." : "Upozornění: pokud asociaci s XML vypnete, bude třeba, abyste pro příponu „.drawio“ ručně zaregistrovali MIME typ application/vnd.jgraph.mxfile.",
  "Kennedy" : "Kennedy",
  "Minimal" : "Minimální",
  "Atlas" : "Atlas",
  "Dark" : "Tmavý",
