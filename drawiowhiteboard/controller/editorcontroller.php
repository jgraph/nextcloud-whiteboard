...
class EditorController extends Controller
{
     ...
     * @param OCA\DrawioWhiteboard\AppConfig $config - app config
     */
    ...
    public function index($fileId, $shareToken = NULL, $filePath = NULL) {
        ...
        if (empty($drawioUrl))
        {
            ...
            return ["error" => $this->trans->t("draw.io Whiteboard app not configured! Please contact admin.")];
        }
        ...
        if (class_exists(LoadViewer::class)) {
            $eventDispatcher->addListener(LoadViewer::class,
                function () {
                        Util::addScript("drawiowhiteboard", "viewer");
