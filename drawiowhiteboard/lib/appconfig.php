...
class AppConfig {
    ...
    // The config keys
    private $_drawioUrl = "DrawioWhiteboardUrl";
    private $_offlinemode = "DrawioWhiteboardOffline";
    private $_lang = "DrawioWhiteboardLang";
    private $_autosave = "DrawioWhiteboardAutosave";
    private $_libraries = "DrawioWhiteboardLibraries";
     ...
     */
    public $formats = [
            "wb" => [ "mime" => "application/vnd.jgraph.mxfile", "type" => "text" ]
        ];
